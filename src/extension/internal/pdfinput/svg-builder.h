...
private:
    ...
    // Style setting
    SPCSSAttr *_setStyle(Inkscape::XML::Node *node, GfxState *state, bool fill, bool stroke, bool even_odd=false);
    void _setStrokeStyle(SPCSSAttr *css, GfxState *state);
    void _setFillStyle(Inkscape::XML::Node *node, SPCSSAttr *css, GfxState *state, bool even_odd);
    ...
    // Colors
    ConvertedColor convertGfxColor(const GfxColor *color, GfxColorSpace *space);
